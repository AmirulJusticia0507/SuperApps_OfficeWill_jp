...
class CourseClassificationInformationController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $request->validate([
            ...
            'classification_name' => 'required',
            'display_order' => 'required',
            'icon_file_path' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048', // Validasi file gambar
        ]);
        ...
        if ($request->hasFile('icon_file_path')) {
            ...
            if ($classification->icon_file_path) {
                Storage::delete(str_replace('/storage/', 'public/', $classification->icon_file_path));
            }
