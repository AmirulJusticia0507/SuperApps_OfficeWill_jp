            ...
            <form method="POST" action="{{ route('course-classification.store') }}" enctype="multipart/form-data" id="classificationForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="icon_file_path" name="icon_file_path" title="Icon File Path">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><i class="fas fa-undo"></i> キャンセル</button>
                    <button type="submit" class="btn btn-primary"><i class="fas fa-send"></i> 提出する</button>
                </div>
            </form>
        </div>
    </div>
