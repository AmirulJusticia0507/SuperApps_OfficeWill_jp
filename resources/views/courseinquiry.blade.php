    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-7">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('course-inquiry') }}" title="Course-specific Inquiry">コース固有の問い合わせ</a></li>
            ...
            <div class="card">
                <div class="card-header" style="background-color: darkblue" title="Course Specific Inquiry"><b style="color:aliceblue">コース固有の問い合わせ</b></div>
                ...
                <div class="card-header" style="background-color: darkblue" title="Employees attending the course"><b style="color:aliceblue"> コースに参加している従業員</b></div>
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div >
                                    ...
                                    <label class="radio-inline ml-3">
                                        <input type="radio" name="search_option" value="After the designated date" title="After the designated date"> 指定日の後
                                    </label>
                                </div>
                            </div>
                        </div>
