                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('course-information.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="coursename" type="text" class="form-control" name="coursename" value="{{ isset($course) ? $course->coursename : '' }}" required style="display: inline-block; width: 60%;" title="Course Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="course_description" id="course_description" class="form-control" cols="5" rows="5" required style="display: inline-block; width: 60%;" title="Course Description"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="possible_retake_course_deadline" style="display: inline-block; width: 30%;">受講期限内の再受講 :<b style="color: red">*</b></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="todo_description" id="todo_description" cols="5" rows="5" class="form-control" title="ToDo Description" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <div style="display: flex; align-items: center;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="test_passed_score" id="test_passed_score" class="form-control" placeholder="xx.xx" style="display: inline-block; width: 10%;" title="Test Pass Threshold">
                                        <p>% 以上の正解で受講修了</p>
                                    </div>
