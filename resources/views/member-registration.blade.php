                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    {{-- <div class="row"> --}}
                        ...
                        <div class="mb-3" style="display: grid; grid-template-columns: auto auto;">
                            ...
                            <div>
                                <input type="checkbox" name="system_admin_privileges" value="1">
                                <label class="checkbox-label">With Permission</label>
                                <input type="checkbox" name="system_admin_privileges" value="0">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-inline-block">
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" class="form-check-input" id="authority_effective_affiliation_1" name="authority_effective_affiliation" value="1">
                                    <label class="form-check-label" for="authority_effective_affiliation_1">Limited to affiliation</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" class="form-check-input" id="authority_effective_affiliation_2" name="authority_effective_affiliation" value="2">
                                    <label class="form-check-label" for="authority_effective_affiliation_2">Below affiliation</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" class="form-check-input" id="authority_effective_affiliation_3" name="authority_effective_affiliation" value="3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email_address_confirmation" id="email_address_confirmation"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="password_expiration_date" id="password_expiration_date"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="number_of_incorrect_passwords">Number of Incorrect
                                            Passwords:</label>
                                        <input type="number" name="number_of_incorrect_passwords"
                                            id="number_of_incorrect_passwords" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="account_lock_date_time">Account Lock Date and Time:</label>
                                        <input type="datetime-local" name="account_lock_date_time"
                                            id="account_lock_date_time" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
