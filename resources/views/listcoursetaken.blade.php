    ...
    {{-- <div class="container"> --}}
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-header" title="Course Description" style="background-color: #92CDFC" align="center"><b style="color:aliceblue">コースの説明:</b></div>
                        <textarea name="course_description" id="course_description" cols="10" rows="10" readonly></textarea>
                    </div>
                </div>
