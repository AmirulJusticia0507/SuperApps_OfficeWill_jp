        ...
        <div class="col-md-6">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Post-course ToDo</li>
                </ol>
            </nav>
            <div id="courseRegistrationWrap">
                <form action="{{ route('confirm-courses.todo-answer.store', $scheduleResultCourse->course->course_id) }}"
                    ...
                    <input type="hidden" name="attendance_settings_id" value="{{ $scheduleResultCourse->attendance_setting_id }}">
                    ...
                    <div class="card">
                        <div id="survey_response" class="card-header" style="background-color: #92CDFC">
                            <div class="row">
                                <div class="col"><b style="color:aliceblue"> {{ $todoTypeTitle }} </b></div>
                            </div>
                        </div>
                        <div class="card-body" x-data="{{ $dataTodoAnswer }}">
                            <template x-for="(todo, index) in todos" :key="index">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-11">
                                        ...
                                        <template x-if="answer[index].choice && todo.choices.find((e) => e.todo_option_id == answer[index].choice).choices == 'others';">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-secondary save-confirm" data-save="0"
                                    data-confirm-title="Post-class To-Do"
                                    data-confirm-html="The input information is temporarily saved.<br>is this good?">Temporarily
                                    saved</button>
                                <button type="submit" class="btn btn-info save-confirm" data-save="1"
                                    data-confirm-title="{{ $confirmTitle }}"
                                    data-confirm-html="{{ $confirmHtml }}">{{ $btnSaveText }}</button>
                            </div>
