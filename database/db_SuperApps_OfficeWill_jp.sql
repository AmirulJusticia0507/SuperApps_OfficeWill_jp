...
) ENGINE=InnoDB AUTO_INCREMENT=10103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `affiliation_information` */

insert  into `affiliation_information`(`affiliation_code`,`company_id`,`affiliation_name`,`display_order`,`organization_type`) values 
(10102,2,'Sendai Head Office 1st Sales Department 2nd Section','060','Main store equivalent');
...
insert  into `company_information`(`company_id`,`company_name`,`login_screen_url`,`icon_storage_file_path`,`teaching_material_storage_file_path`,`created_at`,`updated_at`) values 
(2,'YUMEKOUBOU','Co., Ltd.Dream Workshop, Dream Factory','/storage/icons//EGeyFNlI4qmJnKIGDyHuwqjNjX0e1Mh6p5f9vC73.png','/storage/teaching//rWawqu17Bdg0QT2o4t6F4f5plK0Zg2sxdR8aZEUg.png','2024-05-14 02:14:27','2024-05-14 02:14:27');
...
CREATE TABLE `course_classification_detail_information` (
  ...
  `company_id` int(10) NOT NULL,
  `course_classification_detailsname` varchar(255) DEFAULT NULL,
...
insert  into `course_classification_detail_information`(`course_classification_details_id`,`Course_classification_id`,`company_id`,`course_classification_detailsname`,`icon_file_path`,`display_order`) values 
(1,1,2,'Chiropractic/Body care',NULL,'060'),
(2,1,2,'Chiropractic/Body care',NULL,'060');
...
insert  into `course_classification_information`(`course_classification_id`,`company_id`,`course_classification_name`,`icon_file_path`,`displayorder`) values 
(1,2,'common',NULL,'010'),
(2,2,'common',NULL,'010');
...
('amirul@m2group.co.id','$2y$12$pVA0Vi49BBGePMBhmVH9c.Hi.YC.2Q7T3Iog.rxUC4RoMp/tgAuGe','2024-05-16 01:49:53');
...
CREATE TABLE `questionnaire` (
  ...
  `answer_type` enum('text','radio','checkbox','selectbox') NOT NULL,
...
('KfvWutTwNfowhU0vWgOSBelPqCC6qRWgdL90kqT8',3,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:126.0) Gecko/20100101 Firefox/126.0','',1716876107),
...
(3,'Amirul Putra Justicia','amirul@m2group.co.id',NULL,'$2y$12$NDNeVWvrOjwnpMNIOpzQD.8SeCxp20haIYnHioc/VD58LvTXV50Tq',NULL,'2024-05-14 09:47:44','2024-05-14 09:47:44');
